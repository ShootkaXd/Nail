...
export default function BookingPage() {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-gradient-to-br ${theme.gradient}`}>
      ...
      <header className={`sticky top-0 z-30 glass shadow-sm border-b-0 ${theme.headerBorder}`}>
        <div className="max-w-4xl mx-auto px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-xl font-extrabold text-gradient truncate">{site.salonName}</h1>
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <Link to="/masters" className="text-xs sm:text-sm text-gray-500 hover:text-gray-700 transition-colors px-2 sm:px-3 py-1.5 rounded-xl hover:bg-gray-100">
              Мастера
            </Link>
            <Link to="/my-bookings" className="text-xs sm:text-sm text-gray-500 hover:text-gray-700 transition-colors px-2 sm:px-3 py-1.5 rounded-xl hover:bg-gray-100">
              Мои записи
            </Link>
            <Link to="/login" className="text-xs sm:text-sm text-gray-400 hover:text-gray-600 transition-colors px-2 sm:px-3 py-1.5 rounded-xl hover:bg-gray-100">
              Вход
            </Link>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 overflow-x-hidden w-full">
        ...
        {step === 6 && (
          <div className="surface text-center py-12 px-5 sm:px-8 animate-fade-in-up">
            <ConfettiBurst />
